        ...
        >
          <CarouselContent className="-ml-2 md:-ml-4">
            {testimonials.map((testimonial, index) => (
              <CarouselItem key={testimonial.name} className="pl-2 md:pl-4 sm:basis-1/1 md:basis-1/2 lg:basis-1/2">
                <Card className="bg-card/50 backdrop-blur-sm border border-border/50 p-6 h-full flex flex-col">
