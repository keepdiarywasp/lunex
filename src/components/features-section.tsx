...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="relative py-12 sm:py-20 md:py-32">
      ...
      <div className="container relative px-4 md:px-8">
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16 reveal">
          <h2 className="text-xl sm:text-2xl md:text-4xl font-bold mb-3 sm:mb-4">Advanced Trading Features</h2>
